...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <option value="faculty"    <?php echo e(old('role') === 'faculty'    ? 'selected' : ''); ?>>Faculty / Teacher</option>
                    <option value="researcher" <?php echo e(old('role') === 'researcher' ? 'selected' : ''); ?>>Researcher</option>
                </select>
            </div>
        ...
        <p class="text-center text-muted mb-0" style="font-size:0.875rem;">
            ...
            <a href="<?php echo e(route('login')); ?>" class="fw-semibold">Sign in</a>
        </p>
    </div>
</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\Users\Baby\Desktop\laravel\kandalayang-library\resources\views/auth/register.blade.php ENDPATH**/ ?>