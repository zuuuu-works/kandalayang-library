...
unset($__errorArgs, $__bag); ?>"
        ...
        <p class="text-center text-muted mb-0" style="font-size:0.875rem;">
            ...
            <a href="<?php echo e(route('register')); ?>" class="fw-semibold">Register here</a>
        </p>
    </div>
</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\Users\Baby\Desktop\laravel\kandalayang-library\resources\views/auth/login.blade.php ENDPATH**/ ?>